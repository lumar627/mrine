...
TOKEN = '7699923377:AAEttvx2_wGXgt6Vlgcvg4zKpF9rRQsdqsA'  # Replace with your actual bot token
CHANNEL_ID = '-1002413024371'  # Replace with your specific channel or group ID for attacks
FEEDBACK_CHANNEL_ID = '-1002477764199'  # Replace with your specific channel ID for feedback
message_queue = []


# Official channel details
OFFICIAL_CHANNEL = "@VILAXLORD"  # Replace with your channel username or ID
CHANNEL_LINK = "https://t.me/+OYCS8HiTAxw2MDY1"  # Replace with your channel link
...
def handle_photo(message):
    try:
        ...
        with open(image_path, 'rb') as f:
            ...
            caption = f"VILAX FREE DDOS AISA HAI TOH PAID KAISA HOGA ☠️"
...
def bgmi_command(message):
    ...
    try:
        ...
        if len(args) != 3:
            raise ValueError(" ⚠️Note: Usage: /bgmi <IP> <PORT> <DURATION>")
        ...
        support_button.add(InlineKeyboardButton("🙏 Support 🙏", url="https://t.me/+OYCS8HiTAxw2MDY1"))
...
def send_welcome(message):
    ...
    *_A Powerful DDoS Protection Testing Tool_*
    ...
    🔗 Support: @https://t.me/+OYCS8HiTAxw2MDY1
    🔰 Owner : @VILAXLORD
    """
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📚 Tutorial", url='https://t.me/+OYCS8HiTAxw2MDY1')
    )
...
def send_help(message):
    ...
    📌 *Need Help?*
    Contact support: @https://t.me/+OYCS8HiTAxw2MDY1
    Report issues: @VILAXLORD
    """
    
    # Add support buttons
    markup = telebot.types.InlineKeyboardMarkup()
    markup.add(
        telebot.types.InlineKeyboardButton("🆘 Immediate Support", url='t.me/VILAXLORD'),
        telebot.types.InlineKeyboardButton("📘 Documentation", url='https://t.me/+OYCS8HiTAxw2MDY1')
    )
